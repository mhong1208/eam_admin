...
import { useSupplierLoadAll, type Supplier } from '@/hooks/useSuppliers';
...
const SupplierSelect: React.FC<SupplierSelectProps> = ({ onChange, ...rest }) => {
    const { data: allDepts = [], isLoading } = useSupplierLoadAll();
