...
import { useDepartmentLoadAll } from '@/hooks/useDepartments';
...
const DepartmentSelect: React.FC<DepartmentSelectProps> = ({ onChange, ...rest }) => {
    const { data: allDepts = [], isLoading } = useDepartmentLoadAll();
